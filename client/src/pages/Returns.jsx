...
import { formatCurrency, formatDateTime, getStoreToday, addStoreDays, handleApiError } from '../api/client';
...
const Returns = () => {
  ...
  }, [filterDate, datePreset, statusFilter, searchReceipt]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 rounded-xl bg-white p-4 shadow-sm sm:flex-row sm:flex-wrap sm:items-end">
        <div className="flex flex-wrap items-end gap-2">
          ...
          <div className="flex gap-2 pb-0.5">
            ...
            <Button
              type="button"
              variant={datePreset === 'yesterday' ? 'primary' : 'secondary'}
              size="sm"
              onClick={() => {
                setDatePreset('yesterday');
                setFilterDate(addStoreDays(getStoreToday(), -1));
              }}
            >
              Yesterday
            </Button>
            <Button
              type="button"
              variant={datePreset === 'week' ? 'primary' : 'secondary'}
              size="sm"
      ...
      <Card>
        <Table
          ...
          data={sales}
          loading={loading}
          emptyMessage={datePreset === 'week' ? 'No sales in the last 7 days for this filter' : 'No sales for this date and filter'}
