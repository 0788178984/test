...
/**
 * Choose quantity before adding to cart from the catalogue (fractional kg/L, or whole pieces).
 */
const AddQuantityModal = ({ product, onConfirm, onCancel }) => {
  ...
  const lineTotal = (Number(product.selling_price) || 0) * (Number(qty) || 0);
        ...
        <div className="mb-4 flex items-start justify-between gap-2">
          <div className="min-w-0 flex-1">
            <h2 id="qty-title" className="text-lg font-semibold text-gray-900">
              {byWeight ? 'Amount to sell' : 'Quantity'}
            </h2>
